...
do
	...
	sbatch --ntasks=1 --cpus-per-task=28 enigma.sh 600 output/1-28-0-$ii.out 0
	sbatch --ntasks=1 --cpus-per-task=28 enigma.sh 600 output/1-28-1-$ii.out 1
	sbatch --ntasks=2 --cpus-per-task=28 enigma.sh 600 output/2-28-0-$ii.out 0
	sbatch --ntasks=2 --cpus-per-task=28 enigma.sh 600 output/2-28-1-$ii.out 1
