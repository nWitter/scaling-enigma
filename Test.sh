...
chmod +x enigma.sh
	...
	sbatch --ntasks=2 --cpus-per-task=28 enigma.sh 1000 output/2-28-0-0.out 0 0
	sbatch --ntasks=2 --cpus-per-task=28 enigma.sh 1000 output/2-28-0-1.out 0 1
	sbatch --ntasks=2 --cpus-per-task=28 enigma.sh 1000 output/2-28-0-2.out 1 0.5
	sbatch --ntasks=2 --cpus-per-task=28 enigma.sh 1000 output/2-28-0-3.out 1 1
