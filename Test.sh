...
do
	...
	sbatch --ntasks=1 --cpus-per-task=4 --time=3 enigma.sh 750 output/1-4-0-$ii.out 0
	sbatch --ntasks=1 --cpus-per-task=4 --time=3 enigma.sh 750 output/1-4-1-$ii.out 1
	#sbatch --ntasks=1 --cpus-per-task=4 --time=3 enigma.sh 700 output/n1t4e1-$ii.out 1
	#sbatch --ntasks=1 --cpus-per-task=4 --time=3 enigma.sh 700 output/n1t4e2-$ii.out 2
done
