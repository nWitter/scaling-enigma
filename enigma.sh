...
mpiexec -n $SLURM_NTASKS ${MPI_EXPORT_VARS} ./startInterference.sh 700 output/$SLURM_NTASKS-$SLURM_CPUS_PER_TASK-a$1-n$3.out -a $1 -i $2 -f --duration 120 --timed_loop --step_length $4
