...
chmod +x enigma.sh
	...
	sbatch --ntasks=2 --cpus-per-task=28 ./enigma.sh 1000 output/00.out 0 0
	sbatch --ntasks=2 --cpus-per-task=28 ./enigma.sh 1000 output/01.out 0 0
	#sbatch --nodes=2 enigma.sh 1000 output/1.out 0.5 1 60
	sbatch --ntasks=2 --cpus-per-task=28 ./enigma.sh 1000 output/10.out 1 1
	sbatch --ntasks=2 --cpus-per-task=28 ./enigma.sh 1000 output/11.out 1 1
